            ...
            <div class="col col-md-offset-3 col-md-6">
                <nav class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('tasks.edit', ['folder' => $task->folder_id, 'task' => $task->id])); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                            <div class="form-group">
                                <label for="title">タイトル</label>
                                <input type="text" class="form-control" name="title" id="title" value="<?php echo e(old('title') ?? $task->title); ?>" />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="due_date" id="due_date"
                                    value="<?php echo e(old('due_date') ?? $task->formatted_due_date); ?>" />
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/ToDo_laravel/resources/views/tasks/edit.blade.php ENDPATH**/ ?>